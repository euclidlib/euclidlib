...
`euclidlib` is an **unofficial** Python package developed to facilitate access to data products from the [Euclid Consortium](https://www.euclid-ec.org) Science Ground Segment and Science Working Groups.
