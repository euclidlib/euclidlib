...
def test_pk_gc_with_dummy_data(data_path):
    ...
    data = el.le3.pk_gc.power_spectrum(data_path / "dummy_pk.fits")  # Adjust the function as necessary
    ...
    assert data[('SPE', 'SPE', 0, 0)] is not None, "Power spectrum data should not be None"
